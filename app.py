...
from models import (
    init_db, guardar_lectura, obtener_ultima_lectura, 
...
# ─────────────────────────────────────────
#  ENDPOINT: Recibe datos de la estación
# ─────────────────────────────────────────
@app.route('/data/report/', methods=['POST', 'GET'])
def recibir_datos():
...
def api_actual():
    ...
    # Añadimos la fase lunar al vuelo
...
# ─────────────────────────────────────────
#  API: Análisis Comparativo (Semanal/Mensual)
# ─────────────────────────────────────────
@app.route('/api/stats/comparative')
def api_stats_comparative():
    stats = obtener_stats_agrupadas()
    
    analisis_texto = []
    
    # Lógica básica para generar análisis de texto comparativo
...
# ─────────────────────────────────────────
#  API: Datos de prueba (para testear sin estación)
# ─────────────────────────────────────────
@app.route('/api/test')
def api_test():
    datos_prueba = {
